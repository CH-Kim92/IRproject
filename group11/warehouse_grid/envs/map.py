...
class map2D:
    ...
    def __init__(self):
        ...
        self.robot1 = agent(self.agents_location[0])
        self.robot2 = agent(self.agents_location[1])
        self.robot1._set_goal(self.sp_g[0])
        self.robot2._set_goal(self.sp_g[1])
        self.robot1_actions = path_planning(self.robot1.pos, self.robot1.goal)
        self.robot2_actions = path_planning(self.robot2.pos, self.robot2.goal)
    ...
    def _get_obs(self):
        return {"agent1": [self.robot1.pos, self.robot1.holding], "agent2": [self.robot2.pos, self.robot2.holding]}
    ...
    def start(self):
        self.robot1._set_initpos()
        self.robot2._set_initpos()
        obs = self._get_obs()
        return obs
